    ...
    <div class="row">
      ...
      <div class="owl-slider">
        <div id="carousel" class="owl-carousel">
          ...
          include 'config.php';
          $sql = "select *, news.id as newsid from news join news_image ON news.id=news_image.nid AND news_image.id=(SELECT MIN(image.id) FROM news_image AS image WHERE image.nid=news.id) ORDER BY news.tstamp desc limit 6";
